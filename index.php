...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Agdasima&family=Gloria+Hallelujah&family=League+Spartan:wght@100&family=Lobster&family=Orbitron&family=PT+Mono&family=Rajdhani:wght@500&family=Russo+One&family=Share+Tech+Mono&family=Ubuntu:wght@300;400&family=Viga&family=Voltaire&display=swap"
        rel="stylesheet">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
...
<body>
    ...
    <div id="page1">
        ...
        <div id="qt1">
            " Explore, Discover, and Dance to Your Favorite Beats. <br> Welcome to a World of Endless Melodies."
        </div>
        <div id="qt2">
            "Welcome to MeloVerse, where music transcends <br> boundaries, melodies paint emotions, and rhythm <br>
                    ...
                    <div class="footer-content">
                        <div class="footer-column">
                            ...
                            <div class="footer-buttons">
                                ...
                                <button class="btn" onclick="window.location.href='signup.php'" >Sign In</button>
